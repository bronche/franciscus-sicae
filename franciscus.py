    ...
    with st.spinner("Franciscus rédige sa réponse..."):
        try:
            response = openai.ChatCompletion.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": f"Tu es Franciscus, un assistant de support client pour la SICAE. Tu réponds de façon claire, concise et conviviale en t'appuyant sur ces données : {connaissances}"},
